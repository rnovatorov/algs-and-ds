...
@test(groups=["bfs"], depends_on_groups=["graph"])
class TestBFS(object):
    ...
    @test
    def bfs_in_graph_with_bidirectional_cycle(self):
        """
        Graph:
                         .---(D)---.
                         |         |
    ...
    @test
    def bfs_in_graph_with_directed_cycle(self):
        """
        Graph:
                         .---(D)<--.
                         v         |
